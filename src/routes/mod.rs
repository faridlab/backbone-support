...
/// Create stateless routes for the Support module.
///
...
///
/// ```ignore
/// let module = SupportModule::builder().with_database(pool).build()?;
/// let routes = create_stateless_routes(&module);
/// let app = Router::new().merge(routes);
/// ```
pub fn create_stateless_routes(module: &crate::SupportModule) -> Router<()> {
    Router::new()
        .merge(create_issue_routes(module.issue_service.clone()))
...
pub fn get_routes(module: &crate::SupportModule) -> Router<()> {
    Router::new()
...
/// Create stateful routes for the Support module.
///
...
pub fn create_combined_routes(module: &crate::SupportModule) -> Router<AppState> {
...
/// Get all routes (stateful) for the Support module.
///
/// This is a convenience function that wraps routes with API versioning.
pub fn get_routes_with_state(module: &crate::SupportModule) -> Router<AppState> {
    Router::new()
