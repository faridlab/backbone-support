//! Specifications for ServiceLevelPriority aggregate
//!
...
// Each predicate implements `Specification<ServiceLevelPriority>` and can be combined
...
//
// pub struct ActiveServiceLevelPrioritySpec;
// impl Specification<ServiceLevelPriority> for ActiveServiceLevelPrioritySpec {
//     fn is_satisfied_by(&self, e: &ServiceLevelPriority) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
