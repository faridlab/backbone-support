//! Specifications for Issue aggregate
//!
...
// Each predicate implements `Specification<Issue>` and can be combined
...
//
// pub struct ActiveIssueSpec;
// impl Specification<Issue> for ActiveIssueSpec {
//     fn is_satisfied_by(&self, e: &Issue) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
