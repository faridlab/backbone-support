//! Domain policy for ServiceLevelPriority aggregate
//!
...
/// Domain policy for ServiceLevelPriority — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<ServiceLevelPriority>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type ServiceLevelPriorityDomainPolicy = PermitAllPolicy<ServiceLevelPriority>;
