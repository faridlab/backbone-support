//! ServiceLevelAgreement REST handlers
//!
...
pub enum ServiceLevelAgreementError {
    #[error("Not found: {0}")]
    NotFound(String),
...
impl From<ServiceError> for ServiceLevelAgreementError {
...
impl axum::response::IntoResponse for ServiceLevelAgreementError {
...
/// Create Axum router with all 16 Backbone endpoints for ServiceLevelAgreement.
///
/// # Routes
///
/// | Method | Path | Description |
/// |--------|------|-------------|
/// | GET | /service_level_agreements | List with pagination |
/// | POST | /service_level_agreements | Create new |
/// | GET | /service_level_agreements/:id | Get by ID |
/// | PUT | /service_level_agreements/:id | Full update |
/// | PATCH | /service_level_agreements/:id | Partial update |
/// | DELETE | /service_level_agreements/:id | Soft delete |
/// | POST | /service_level_agreements/bulk | Bulk create |
/// | POST | /service_level_agreements/upsert | Upsert |
/// | GET | /service_level_agreements/trash | List deleted |
/// | POST | /service_level_agreements/:id/restore | Restore |
/// | DELETE | /service_level_agreements/empty | Empty trash |
/// | GET | /service_level_agreements/:id/deleted | Get deleted by ID |
/// | DELETE | /service_level_agreements/trash/:id | Permanent delete from trash |
/// | GET | /service_level_agreements/count | Count active entities |
/// | GET | /service_level_agreements/trash/count | Count deleted entities |
///
/// # Example
///
/// ```text
/// let service = Arc::new(ServiceLevelAgreementService::with_repository(repository));
